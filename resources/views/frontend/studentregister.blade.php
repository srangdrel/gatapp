                                 ...
                                 <tr>
                                  ...
                                  <div >
                                   ...
                                   <td colspan="2"><div class="d-flex justify-content">
                                     <input type="button" class="btn btn-primary btn-lg btn-block " value="  Exit  " onclick="Exit()"><div  style="float:right;margin-left:150%;"><input type="submit" class="btn btn-primary btn-lg btn-block"  name="ex" value="Enter" onclick="studentEntry()"></div>
                                    </div></td>
